...
export const POLITICIAN_SEEDS: PoliticianSeed[] = [
    {
        ...
        portfolioTopics: [
            'prime minister', 'cabinet', 'governance', 'development', 'vikasit bharat',
            'infrastructure', 'foreign policy', 'economy', 'parliament', 'yojana', 'scheme',
        ],
    ...
    },
    {
        ...
        party: 'BJP',
        portfolio: 'Railways / IT / Communications',
        portfolioTopics: [
