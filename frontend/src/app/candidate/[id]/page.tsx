        ...
        return (
            <div className="flex flex-col md:flex-row min-h-screen bg-black">
                ...
                <main className="flex-1 p-4 pt-20 md:p-8 w-full animate-pulse">
                    ...
                    <div className="w-40 h-8 bg-black rounded-lg mb-6"></div>
                    {/* Header Skeleton */}
                    <div className="bg-black rounded-2xl border border-white/10 p-6 mb-6 h-32"></div>
                    <div className="h-64 bg-black rounded-2xl border border-white/10 mb-6"></div>
                </main>
            </div>
        );
    }
        ...
        <div className="flex flex-col md:flex-row min-h-screen bg-black">
            ...
            <main className="flex-1 p-4 md:p-8 pt-20 md:pt-8 w-full">
                ...
                <motion.div
                    ...
                    className="bg-black  rounded-2xl border border-white/10 p-6 mb-6"
                >
                    ...
                    <div className="mt-4 flex gap-4">
                        ...
                        <span className="px-4 py-2 bg-black text-gray-400 rounded-lg">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    {candidate.riskNotes && (
                        <motion.div
                            ...
                            className="bg-black  rounded-2xl border border-white/20 p-6"
                        >
                    ...
                    {candidate.resumeFeedback && (
                        <motion.div
                            ...
                            className="bg-black  rounded-2xl border border-white/10 p-6 lg:col-span-2"
                        >
