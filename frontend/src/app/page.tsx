    ...
    return (
        <main className="min-h-screen bg-black text-white selection:bg-white/20">
            ...
            <header className="fixed top-0 w-full z-50 border-b border-white/10 bg-black/50 backdrop-blur-md">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <Link href="/workers" className="text-sm text-zinc-400 hover:text-white transition-colors">Directory</Link>
                        <Link href="/api/auth/signin">
                            <LiquidButton className="px-5 py-2 text-sm text-white border-white/20">Login</LiquidButton>
                        </Link>
                    </div>
                </div>
            </header>
            ...
            <section className="pt-40 pb-20 px-6 max-w-7xl mx-auto text-center flex flex-col items-center">
                <div className="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-3 py-1 text-sm mb-8 text-zinc-300 backdrop-blur-sm">
                    <span className="flex h-2 w-2 rounded-full bg-green-500 mr-2 animate-pulse"></span>
                    The workspace for disciplined builders
                </div>
                
                <h1 className="text-5xl md:text-7xl font-bold tracking-tighter mb-6 bg-gradient-to-r from-white to-zinc-500 bg-clip-text text-transparent max-w-4xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                    <Link href="/itime">
                        <LiquidButton className="w-full sm:w-auto px-8 py-3 text-white text-lg font-medium ring-1 ring-white/30">
                            Start Measuring Work
                        </LiquidButton>
                    </Link>
                    <Link href="/workers">
                        <LiquidButton className="w-full sm:w-auto px-8 py-3 text-white bg-transparent border-white/10 hover:bg-white/5 text-lg">
                            View Leaderboard
                        </LiquidButton>
                    </Link>
                </div>
            ...
            <section className="py-24 px-6 max-w-7xl mx-auto border-t border-white/5">
                <div className="text-center mb-16">
                    <h2 className="text-3xl font-bold tracking-tight mb-4 text-white">Systems for Scale</h2>
                    <p className="text-zinc-400">Everything you need to stay disciplined and execute globally.</p>
                </div>
            ...
            {/* Footer */}
            <footer className="border-t border-white/10 py-12 px-6 mt-12 bg-black">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between text-zinc-500 text-sm">
                    ...
                    <div className="flex gap-6 mt-4 md:mt-0">
                        <Link href="/workers" className="hover:text-white transition-colors">Directory</Link>
                        <Link href="/itime" className="hover:text-white transition-colors">iTime</Link>
                    </div>
                </div>
            </footer>
        </main>
...
function FeatureCard({ title, description, icon }: { title: string, description: string, icon: string }) {
    return (
        <div className="bg-[#050505] border border-white/10 rounded-2xl p-8 hover:bg-[#0a0a0a] transition-colors group">
